...
WORK_DIR=${PROJECT_ROOT}/data/dparsf_work/full_${BAND_NAME}
FUNIMG_SOURCE_DIR=${PROJECT_ROOT}/data/raw/func_preproc
SUBJECT_LIST_FILE=${WORK_DIR}/SubjectList.txt
CONFIG_FILE=${PROJECT_ROOT}/data/dparsf_work/full_configs/Cfg_${BAND_NAME}_full.mat
